...
export default function Home() {
  ...
  const { products: trendingProducts } = UseProducts(6);
  const { products: dealProducts } = useCategoryProducts("smartphones", 4);

  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
      {/* Hero Section - Top Tech */}
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white shadow-xl">
      ...
      {/* Trending Products */}
      <section>
        <h2 className="text-3xl font-bold mb-6 text-gray-800">Trending</h2>
      ...
      {/* Best Deals */}
      <section className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-8 text-white shadow-xl">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
